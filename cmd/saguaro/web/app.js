...
<p class="muted">Šifriranje je obavezno (age); off-site arhive su već šifrirane pa transport samo mora biti autenticiran.</p><div id="bkMsg" class="muted"></div></form></div>${filesPanel}`;
