...
${help('<b>Interni CA (step-ca)</b> izdaje certifikate za LAN uređaje i sam GUI bez javne domene — dodaj SAN-ove (nazivi/IP-ovi) i po želji postavi kao GUI certifikat. <b>Javni ACME (Let’s Encrypt)</b> je za servise izložene internetu preko DNAT-a (u pripremi). Za IPsec cert-auth iskoristi ovdje izdani cert ili unesi tuđi.')}<table><thead><tr><th>Ime</th><th>SAN-ovi</th><th>Izdan</th><th>Istječe</th><th></th></tr></thead><tbody>${rows}</tbody></table>
