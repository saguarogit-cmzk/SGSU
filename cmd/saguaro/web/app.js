...
const UTM_MODULES=new Set(['gateway','fwrules','ids','vpn','sitevpn','ipsec','multiwan']);
...
const rule={name,action:$('#ruAction').value,proto,srcAlias:$('#ruSrc').value,dstAlias:$('#ruDst').value,dstPort:port,enabled:$('#ruEnabled').checked};
