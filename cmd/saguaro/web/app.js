...
<div class="wizRow"><button id="idsOn" ${d.hw.ok?'':'disabled'}>Uključi IDS</button> <button id="ipsWiz" ${d.hw.ok?'':'disabled'}>Postavi IPS</button> <button id="idsUpd" class="ghost" title="Preuzmi najnoviju bazu prepoznavanja (suricata-update) i ponovno učitaj Suricatu">Ažuriraj pravila</button> <button id="idsOff" style="background:#e05d5d">Emergency IPS off</button></div>
