...
${help('<b>Način:</b> <b>Failover (pričuva)</b> = radi točno <b>jedna</b> veza; sav promet ide kroz <b>primarnu</b>, a kad ona padne (ne prolazi provjera dostupnosti) automatski se prebaci na <b>sekundarnu</b>, pa se vrati čim se primarna oporavi. <b>Balans (load-balance)</b> = promet se dijeli preko <b>svih ispravnih</b> veza istovremeno, po težini (brža veza dobije veći udio); kutija sama pazi da odgovor izađe kroz istu vezu kroz koju je promet i ušao. <br><br>U failoveru <b>redoslijed = prioritet</b> (vrh = primarni; presloži strelicama), a težina se ignorira. <b>Provjera dostupnosti (health-check)</b> je IP koji kutija povremeno pinga kroz svaku vezu da zna radi li ona. Zahtijeva <b>Gateway mod</b>. Primjena mijenja default rutu uz <b>120 s potvrdu</b> (auto-rollback ako izgubiš pristup). Preporuka: simuliraj ispad primarnog prije produkcije.')}
...
${help('Kutija po defaultu <b>sama rekurzivno</b> rješava internet DNS (Unbound → root serveri). Ovdje umjesto toga možeš cijelu rekurziju <b>proslijediti šifrirano (DNS-over-TLS, port 853)</b> na povjerljivog providera (Cloudflare, Quad9, Google) ili vlastiti — tako ISP ne vidi koje domene tražiš. TLS certifikat upstreama se provjerava (<i>tls-cert-bundle</i>). <br><br><i>Napomena:</i> Unbound je nativni <b>DoT</b> klijent; DoH (preko HTTPS-a) Unbound ne podržava kao upstream. Isključeno = kutija ostaje puni rekurzivni resolver (preporuka za maksimalnu neovisnost).')}
